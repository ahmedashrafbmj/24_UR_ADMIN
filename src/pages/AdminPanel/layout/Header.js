...
const Header = () => {
    ...
    useEffect(() => {
        if (Token === null) {
            ...
            Navigate('/',  {state: { historyLocation: location.pathname }} )
    ...
    const logout = () => {
        ...
        fetch(`${Baseurl.baseUrl}/superadmin/logout`, requestOptions)
            .then(response => response.json())
            .then(result =>
                {
    ...
    const ChangePasswordFunction = () =>{
        ...
        if (NewPassword == "") {
            ...
            fetch(`${Baseurl.baseUrl}/superadmin/changepassword`, requestOptions)
                .then(response => response.json())
                .then(result =>
                    {
                        console.log(result)
                ...
                <div className="main-menu-content">
                    <Scrollbars style={{ maxWidth: 260, height: "90vh" }}>
                        <ul className="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                            ...
                            <li className=" nav-item">
                                {/* <Link to={"/addsubadmin"} > */}
                                    <a  onClick={() => Navigate('/addsubadmin')}>
