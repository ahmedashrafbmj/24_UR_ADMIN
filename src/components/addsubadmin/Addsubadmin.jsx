...
const Addsubadmin = ({Role}) => {
    ...
    const addCategory = () => {
        ...
        fetch(`${Baseurl.baseUrl}/subadmin/registration`, requestOptions)
            .then(response => response.json())
            .then(result => {
                    ...
                    <div className="content-body">
                        <div style={{ maxWidth: "100%" }}>
                            <MaterialTable
                                ...
                                columns={[
                                    // render: price => `${price}`  }
                                    { title: "Hospital Name", field: "hname" },
                                    ...
                                    {
                                        title: "Hospital Status", field: "status", render: rowData =>
                ...
                <Modal.Body>
                    ...
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            ...
                            <Form.Control
                                ...
                                autoFocus
                                onChange={(e) => handleInputChange(e, Sethname)}
                            />
